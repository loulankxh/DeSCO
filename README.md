...
Normally the experiment time would be 2-3 hours (can be completed using a personal laptop). And if under good network and computer conditions, the overall time would be less than one hour to get all results.
